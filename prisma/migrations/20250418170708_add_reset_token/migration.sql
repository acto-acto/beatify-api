...
INSERT INTO "new_User" ("avatar_url", "created_at", "email", "full_name", "id", "password", "refresh_token", "reset_otp", "updated_at", "user_name") SELECT "avatar_url", "created_at", "email", "full_name", "id", "password", "refresh_token", "reset_otp", "updated_at", "user_name" FROM "User";
DROP TABLE "User";
